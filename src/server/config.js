const config = {
  ...
  customCssPath: process.env.CUSTOM_CSS_PATH || './config/custom.css',
  footerPath: process.env.FOOTER_PATH || './config/footer.md',
  bangsPath: process.env.BANGS_PATH || './config/bangs.md',
